...
const ProjectCard = ({ index, name, description, tags, img, source_code_link, site_link }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div 
          className='bg-tertiary rounded-2xl py-4 px-4 min-h-[280px] 
          flex justify-evenly flex-col'
        >
          <div className="relative w-full h-[230px]">
          <LazyLoad height={200} offset={200} threshold={0.95}>
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={styles.sectionSubText}>My Works and Side Projects</p>
